...
@define('METADATA','/hsphere/local/home/aaalqze/vietnam-cambodia-tours.com/galatouristen-images/meta/send-email.html');
...
<?php include '/hsphere/local/home/aaalqze/vietnam-cambodia-tours.com/component/send-email.php';foreach(Esnc::$x_append as $value) echo $value;
?><script src="/js/library.js" language="javascript" type="text/javascript"></script>
