...
@define('METADATA','/hsphere/local/home/aaalqze/vietnam-cambodia-tours.com/galatouristen-images/meta/news-print.html');
...
<body class="send_email_bd">
	<?php include '/hsphere/local/home/aaalqze/vietnam-cambodia-tours.com/component/news-print.php';foreach(Esnc::$x_append as $value) echo $value;
