<?php
if($row->ctrl&CATPRODUCT_CTRL_LAOS){
    ?>
    <li class="dropdown li_dropdown">
        ...
        <ul class="dropdown-menu menu_tour_ul_0" role="menu">
            ...
            <?php } ?>
            <?php
            $rs_hotel = catproductlist(CATPRODUCT_CTRL_SHOW|CATPRODUCT_CTRL_HOTEL|CATPRODUCT_CTRL_LAOS,null,true,null,100);
            ...
            while ($temp = mysql_fetch_object($rs_useful))
                if($temp->ctrl&CATNEWS_CTRL_LAOS){
                    $item = $temp;
                    break;
                }
            if($item){
