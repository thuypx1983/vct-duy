...
<Div class="patch_all">
	...
	<A class="patch_link" href="'.urlBuild('attraction-list.php',array('url'=>$cat->urlrewrite)).'">'.$cat->name.'</A>>
...
<Div class="other_tour_all">
	<div class="title_other_tour_">
		<h2><?php echo @T_NEWS_EVENTS_SIMILAR ?></span></h2>
	</div>
	<?php 
	...
	while ($row = mysql_fetch_object($rs)){
		if(($row->id!=$item->id)){
			$href = urlBuild('attraction-detail.php',array('CNname'=>$cat->urlrewrite,'url'=>$row->urlrewrite));
	?>
