	...
	function process(){
		...
		switch($this->act){
			...
			case ACT_SEARCH:
				...
				exit();
			case ACT_ADD:
				include_once(PATH_CLASS.'catutility.php');
				$item = new catutility;
...
$o = new catlist;
$o->type=$o->allowpaste=TABLE_UTILITY;
$o->a_ctrl = &$CATUTILITY_CTRL;//array of constants definition
$o->table='catutility';
$o->tbitem='utility';
$o->flag=&$FOLDER_FLAG;
$o->alias='CU';
...
$o->doctitle = "Qu&#7843;n tr&#7883; t&agrave;i li&#7879;u";
$o->process();
