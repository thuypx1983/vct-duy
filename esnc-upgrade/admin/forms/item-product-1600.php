	...
	<thead>
		<tr height="23" style="background-image:url(images/bg-product.gif);">
		  <td align="center">
			...
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_detail',this);">Direction</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf3',this);">Destination nearby</span>
			
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf9',this);">Other Information</span>
			
			<!-- <strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_warranty',this);"><?php echo 'Check rates';?></span> -->
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf0',this);">Restaurant & Bar</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf1',this);">Room Information</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf10',this);">Policy</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf8',this);">Room Facilities</span>
...
?>
	...
	<div style="width:100% ">
		<?php
		$oFCKeditor = new FCKeditor('cf[8]') ;
		$oFCKeditor->BasePath	= $sBasePath ;
		$oFCKeditor->Height = 300 ;
		//$oFCKeditor->Config[ 'ToolbarLocation' ] = 'Out:xToolbar' ;
		$oFCKeditor->Value		=  $this->cf[8];
		$oFCKeditor->Config['EnterMode'] = 'br';$oFCKeditor->Create() ;
		?>
	</div>
	</td></tr>
