...
<tr>
	<td>
		<div class="title">S&#7889; ch&#7895;</div>
		<div><input type="text" onFocus="HIDE('attribute');" name="include" value="<?php echo $this->include; ?>" style="width:80%;"></div>
	</td>
	<td  colspan="2">
		<div class="title">Lo&#7841;i</div>
		<div><input type="text" onFocus="HIDE('attribute');" name="unit" value="<?php echo $this->unit; ?>" style="width:52%;"></div>
	</td>
</tr>
<tr><td colspan="3">
	<table width="80%">
	<thead>
		<tr height="23" style="background-image:url(images/bg-product.gif);"><td align="center">
			...
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf0',this);">Qu&#7843;n l&#253; gi&#225;</span>
		</td></tr>
	</thead>
