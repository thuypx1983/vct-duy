...
<tr>
	<td colspan="3">
		<div class="title">T&#234;n Service</div>
		<div><input type="text" onFocus="HIDE('attribute');" name="name" value="<?php echo $this->name; ?>" style="width:50%;"></div>
	</td>
</tr>
<tr>
	<td colspan="3">
		<div class="title">Urlrewrite</div>
		<div><input style="width:50%;" type="text" onFocus="HIDE('attribute');" name="urlrewrite" value="<?php echo $this->urlrewrite; ?>" style="width:90%;"></div>
	</td>
	<td colspan="2">
	</td>
</tr>
