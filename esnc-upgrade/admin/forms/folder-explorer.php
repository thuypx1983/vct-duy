...
<tbody>
	...
	<tr>
		...
		<td align="left"><input type="text" id="name<?php echo $i; ?>" class="input" style="border:1px solid #FFFFFF; width:100%; cursor:pointer" readonly="yes" value="<?php echo $this->rs[$i]; ?>" onDblClick="<?php echo $openscript; ?>"/></td>
		<td align="center"><span onclick="rename(<?php echo $i; ?>,this);" class="textbutton">&#272;&#7893;i t&ecirc;n</span><?php echo $openact; ?><?php echo $showsrc;?>|<span class="textbutton" onClick="downloadItem(<?php echo $i; ?>);">T&#7843;i v&#7873;</span></td>
	</tr>	
	<?php }//end row scan?>	
</tbody>
<tfoot>
...
?>	</td>
	...
	<tr  style="background-color:white; ">
		<td colspan="3" align="right" style="padding-right:5px;border-bottom:0px none; " valign="baseline">T&#7843;i t&#7853;p tin l&ecirc;n m&aacute;y ch&#7911;</td>
		<td valign="baseline" style="border-bottom:0px none; "></td>
	</tr>
</tfoot>
</table>
</body>
...
function doNewItem(){
	window.open(URL_ADMIN + 'pte.php?<?php echo urlformat($this->q,'FLid',$this->catid,'filename',getuniquename().'.'.$this->ext) ?>','subWindow',sParams);
}
function doNew(){
	doNewItem();
}
...
function downloadItem(i){
	window.open('<?php echo $itemurl ?>' + document.getElementById('name'+i).value);
}
function openItem(i){
