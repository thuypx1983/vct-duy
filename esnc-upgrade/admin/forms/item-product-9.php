...
<tr>
	<td>
	<div class="title">M&atilde; d&#7883;ch v&#7909;</div>
	<div><input type="text" onFocus="HIDE('attribute');" value="<?php echo $this->code; ?>" style="width:150px;" ></div>
	</td>
	<td width="66%">
	<div class="title">T&ecirc;n d&#7883;ch v&#7909;</div>
