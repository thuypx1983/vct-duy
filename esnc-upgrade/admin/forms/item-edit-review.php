...
?>
<form name="form" method="post" action="<?php echo URL_SELF.'?act='.ACT_SAVE.'&PDid='.$PDid.'&catid='.$CPid.'&id='.$id ?>" class="head"></form>
...
<table width="70%" cellpadding="3" cellspacing="0" border="0">
 ...
 <tr>
 	<td>Người Gửi</td>
 	<td><input type="text" size="50" name="custname" value="<?php echo $row->custName?>"></td>
 </tr>
 </tbody>
</table>
