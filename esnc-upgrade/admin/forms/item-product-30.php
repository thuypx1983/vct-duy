...
<tr>
	<td>
		<div class="title">Gi&#225; resort t&#7915; - &#273;&#7871;n</div>
		<div>
			...
			<input type="text" onFocus="HIDE('attribute');" name="warranty" class="input" style="width:60px"  value="<?php echo htmlspecialchars($this->warranty); ?>" />
		</div>
	</td>
<td colspan="2">
	...
	<div style="float:left;width:35%;margin-left:5px;">
		...
		<div><nobr><input type="text" onFocus="HIDE('attribute');" name="country" class="input" style="width:50%;"  value="<?php echo htmlspecialchars($this->country); ?>" /><select onchange="this.previousSibling.value=this.options[this.selectedIndex].text">		<option value="<?php echo $this->country ?>" selected><?php echo $this->country ?></option><?php echo @readfile(PATH_APPLICATION.'countrycodes.htm'); ?></select></nobr></div>
	</div>
	</td>
</tr>
<tr>
	<td colspan="3">
		...
		<div>
			<input type="text" onFocus="HIDE('attribute');" name="unit" class="input" style=" width:250px"  value="<?php echo htmlspecialchars($this->unit); ?>" />
		</div>
	</td>
</tr>
<tr><td colspan="3">
	...
	<thead>
		<tr height="23" style="background-image:url(images/bg-product.gif);"><td align="center">
			...
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf0',this);">Ph&#242;ng ngh&#7881; v&#224; d&#7883;ch v&#7909;</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf1',this);">B&#7843;ng gi&#225;</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf2',this);">V&#7883; tr&#237; t&#432;&#417;ng quan</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf3',this);">Ch&#237;nh s&#225;ch</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf4',this);">Khuy&#7871;n m&#227;i</span>
		</td></tr>
	</thead>
