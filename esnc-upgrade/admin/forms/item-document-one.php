...
<?php if((int)$act == ACT_SAVE){
	if(preg_match('/^\w+$/',$this->fn)) echo 'window.top.content.';echo $this->fn ?>('<?php echo $this->name ?>','<?php echo $this->extension ?>',<?php echo (int)array_search($this->extension,$FILE_ALLOW_EDIT_TYPE); ?>,0);
<?php 
}
?>
</script>
