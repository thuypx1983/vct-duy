...
<form action="<?php echo URL_SELF ?>?productid=<?php echo $this->productid ?>" method="post" id="PPlist">
<?php
	...
	<?php }
	?>
	<div style="clear:both;padding-left:30px; padding-top:20px"><input class="button"  type="button" value="Xóa Ảnh" onClick="doDel1();" /></div>
</form>
<br/>
...
-->
	...
	<table border="0" bordercolor="#111111" style="border-collapse:collapse" class="text" cellspacing="3" align="center">
		<thead class="text"><tr><td>TT</td><th>Ch&#7885;n &#7843;nh</th><th>title</th><th>alt</th><th>url</th><th>Giới hạn kích thước</th></tr></thead>
		<tbody class="text">
			<form action="<?php echo URL_CWD ?>photo-upload.php?fn=window.top.content.nextupload&act=<?php echo ACT_SAVE;?>&productid=<?php echo $this->productid;?>&FLid=" id="frmUpload1" enctype="multipart/form-data" target="frameupload" method="post" class="frmMultiUpload">
				...
				<tr>
					<td>
						<input type="text" name="view" value="<?php echo ++$lastview; ?>" class="input" style="width:20px "/>
					</td>
					<td>
					...
					<td><input align="" name="size1" type="text" value="<?php echo IMAGE_PRODUCT_UPLOAD;?>" /></td>
				</tr>
			</form>
...
<div id="divFormEditImage" class="text"> 
	<form action="<?php echo URL_SELF ?>?act=<?php echo ACT_SAVE;?>&productid=<?php echo $this->productid ?>" method="post" id="frmEditImage">
		<div class="text"><span class="title_photo">Title</span><textarea name="name" class="input" style="width:250px; "></textarea></div>
		<div class="text"><span class="title_photo">Alt</span><textarea name="alt" class="input" style="width:250px; "></textarea></div>
		<div class="text"><span class="title_photo">Url</span><input name="url" class="input"  type="text" style="width:250px; " /></div>
		<div class="text"><span class="title_photo">Order</span><input name="view" class="input"  type="text" style="width:20px; " /></div>
		<div style="text-align:center " class="text">
		<input class="button"  type="submit" value="Ch&#7845;p nh&#7853;n" />&nbsp;
...
function  doSaveImgEdit(newImg1){
