...
<tr>
	...
	<td>
		...
		<div><input type="text" name="name" class="input" style="width:60%;" value="<?php echo htmlspecialchars($this->name) ?>"></div>
	</td>
	<td >
	<div class="title">T&#234;n </div>
	<div><input type="text" name="price" value="<?php echo $this->price ?>" style="width:95%;"></div>
	</td>
</tr>
<tr>
	<td>
...
<tr>
	...
	<td>
		...
		<div>
		<textarea onFocus="HIDE('attribute');" rows="10" name="summary" class="input" style="width:100%;"><?php echo htmlspecialchars($this->summary); ?></textarea></div>
	</td>
