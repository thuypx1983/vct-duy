...
<body style="margin: 0px 0px 0px 0px" class="text"><table id="item-list" width="100%" cellpadding="0" cellspacing="0"  onClick="parent.document.getElementById('newitemmenu').style.visibility='hidden';">
	<thead>
	<tr>
	  <th width="6%"><input type="checkbox" onClick="javascript:setAll('id',this.checked);"></th>		
		<th width="45%"><?php echo COL2_NAME ?></th>
		<th width="18%" ><?php echo COL7_NAME ?></th>
		<th width="11%"><a href="<?php echo $this->url.'?'.urlformat($this->q,$this->alias.'sortby',($this->sortby == SORTBY_CREATED_ASC ? SORTBY_CREATED_DESC : SORTBY_CREATED_ASC)) ?>" class="search"><?php echo COL3_NAME ?></a></th>
		<th width="6%"><?php echo COL4_NAME ?></th>
		<th width="8%"><a href="<?php echo $this->url.'?'.urlformat($this->q,$this->alias.'sortby',($this->sortby == SORTBY_VIEW_ASC ? SORTBY_VIEW_DESC : SORTBY_VIEW_ASC)) ?>" class="search"><?php echo COL5_NAME ?></a></th>
		<th width="6%" ><?php echo COL6_NAME ?></th>
	</tr>
	</thead>
	<tbody>
	<?php 
	...
	<tr>
		...
		<td align="left">
			...
			|<a href="<?php echo URL_CWD ?>link.php?<?php echo ALIAS ?>id=<?php echo $row['id'] ?>&<?php echo CATALIAS ?>id=<?php echo $this->catid ?>&<?php echo ALIAS ?>link=news" class="item" style="padding-left:3px; ">Bài liên quan</a>
			|<a href="<?php echo URL_CWD ?>link.php?<?php echo ALIAS ?>id=<?php echo $row['id'] ?>&<?php echo CATALIAS ?>id=<?php echo $this->catid ?>&<?php echo ALIAS ?>link=product" class="item" style="padding-left:3px; ">Sản phẩm</a>
		</td>
