...
<tr>
	...
	<div style="float:left;width:49%;margin-left:5px;">
		...
		<div><input type="text"  name="urlrewrite" class="input" style="width:500px;"  value="<?php echo htmlspecialchars($this->urlrewrite); ?>" /></div>
	</div>	
	</td>
</tr>
<tr><td colspan="3">
	...
	<thead>
		<tr height="23" style="background-image:url(images/bg-product.gif);"><td align="center">
			...
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf2',this);">Hotels</span>
		</td></tr>
	</thead>
