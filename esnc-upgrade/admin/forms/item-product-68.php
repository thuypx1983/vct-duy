...
<tr>
	<td colspan="3">
		<div class="title">V&#7883; tr&#237; t&#432;&#417;ng quan</div>
		<div>
			<input type="text" onFocus="HIDE('attribute');" name="unit" class="input" style=" width:680px"  value="<?php echo htmlspecialchars($this->unit); ?>" />
		</div>
	</td>
</tr>
<tr><td colspan="3">
