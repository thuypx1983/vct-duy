...
<col width="14%" /><col width="14%" /><col width="14%" /><col width="14%" /><col width="14%" /><col width="14%" /><col width=""/>
<tr>
	<td>
	...
	<td>
		<div class="title">Gi&aacute; khuy&#7871;n m&#7841;i  </div>	
	</td>
	<td>
		<div class="title">&#272;&#417;n v&#7883; t&iacute;nh</div>
	</td>
	<td>
		<div class="title">T&igrave;nh tr&#7841;ng kho(QT)  </div>
	</td>
	<td>
		<div class="title">H&igrave;nh th&#7913;c v&#7853;n chuy&#7875;n   </div>
	</td>

</tr>
<tr>
	<td>	
		<div class="input"><input type="text" onFocus="HIDE('attribute');" value="<?php echo htmlspecialchars($this->code); ?>" style="width:100px;" name="code" /></div>
	</td>
	<td>
		<div class="input"><input type="text" onFocus="HIDE('attribute');" name="name" value="<?php echo htmlspecialchars($this->name); ?>" style="width:100%;"></div>	
	</td>
	<td>
		<div class="input"><input type="text" onFocus="HIDE('attribute');" name="saleprice" value="<?php echo currency_format_number($this->saleprice); ?>" style="width:100%;"></div>
	</td>
	
	<td>
		<div class="input"><input type="text" onFocus="HIDE('attribute');" name="price" value="<?php echo currency_format_number($this->price); ?>" style="width:100%;"></div>
	</td>
	<td>
		<div class="input"><input type="text" onFocus="HIDE('attribute');" name="unit"  class="input" style="width:100px;"  value="<?php echo htmlspecialchars($this->unit); ?>" /></div>
	</td>
	<td>
		<div class="input"><input type="text" onFocus="HIDE('attribute');" name="warranty"  class="input" style="width:100px;"  value="<?php echo htmlspecialchars($this->warranty); ?>" /></div>
	</td>
	
	<td>
		<div class="input"><input type="text" onFocus="HIDE('attribute');" name="model"  class="input" style="width:100px;"  value="<?php echo htmlspecialchars($this->model); ?>" /></div>
	</td>
...
<tr>
	<td col="2"><div class="title"><?php echo "Thu&#7897;c t&iacute;nh s&#7843;n ph&#7849;m ";?></div></td>
</tr>
<tr>
	<td><div class="text_area">
		<table><col width="26%" /><col width="" />
			<tr>
				...
				<td style="width:400px;"><input type="text" onFocus="HIDE('attribute');" value="<?php echo htmlspecialchars($this->a_attr[0]); ?>" style="width:680px;" name="a_attr[0]" /></td>
			</tr>
			<tr>
				<td><?php echo T_ATTR_1; ?></td>
				<td><input type="text" onFocus="HIDE('attribute');" value="<?php echo htmlspecialchars($this->a_attr[1]); ?>" style="width:680px;" name="a_attr[1]" /></td>
			</tr>
			<tr>
				<td><?php echo T_ATTR_2; ?></td>
				<td><input type="text" onFocus="HIDE('attribute');" value="<?php echo htmlspecialchars($this->a_attr[2]); ?>" style="width:680px;" name="a_attr[2]" /></td>
			</tr>
			<tr>
				<td><?php echo T_ATTR_3; ?></td>
				<td><input type="text" onFocus="HIDE('attribute');" value="<?php echo htmlspecialchars($this->a_attr[3]); ?>" style="width:680px;" name="a_attr[3]" /></td>
			</tr>
			<tr>
				<td><?php echo T_ATTR_4; ?></td>
				<td><input type="text" onFocus="HIDE('attribute');" value="<?php echo htmlspecialchars($this->a_attr[4]); ?>" style="width:680px;" name="a_attr[4]" /></td>
			</tr>
			<tr>
				<td><?php echo T_ATTR_5; ?></td>
				<td><input type="text" onFocus="HIDE('attribute');" value="<?php echo htmlspecialchars($this->a_attr[5]); ?>" style="width:680px;" name="a_attr[5]" /></td>
			</tr>
			<tr>
				<td><?php echo T_ATTR_6; ?></td>
				<td><input type="text" onFocus="HIDE('attribute');" value="<?php echo htmlspecialchars($this->a_attr[6]); ?>" style="width:680px;" name="a_attr[6]" /></td>
			</tr>
			<tr>
				<td><?php echo T_ATTR_7; ?></td>
				<td><input type="text" onFocus="HIDE('attribute');" value="<?php echo htmlspecialchars($this->a_attr[7]); ?>" style="width:680px;" name="a_attr[7]" /></td>
			</tr>
			<tr>
				<td><?php echo T_ATTR_8; ?></td>
				<td><input type="text" onFocus="HIDE('attribute');" value="<?php echo htmlspecialchars($this->a_attr[8]); ?>" style="width:680px;" name="a_attr[8]" /></td>
			</tr>
			<tr>
				<td><?php echo T_ATTR_9; ?></td>
				<td><input type="text" onFocus="HIDE('attribute');" value="<?php echo htmlspecialchars($this->a_attr[9]); ?>" style="width:680px;" name="a_attr[9]" /></td>
			</tr>
		</table></div>
	</td>
</tr>
...
<tr>
	...
	<td>
		<input type="text" onFocus="HIDE('attribute');" size="2" name="status" class="input" value="<?php echo htmlspecialchars ($this->status); ?>" style="width:100%;"/>
	</td>
	<td>
