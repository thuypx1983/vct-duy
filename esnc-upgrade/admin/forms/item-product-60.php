...
<tr>
	<td colspan="3">
		<div class="title">T&#234;n Ticket</div>
		<div><input size="90" type="text" onFocus="HIDE('attribute');" name="name" value="<?php echo $this->name; ?>"></div>
	</td>
</tr>
<tr>
	<td>
		<div class="title">H&#227;ng h&#224;ng kh&#244;ng</div>
		<div><input size="65" type="text" onFocus="HIDE('attribute');" name="model" value="<?php echo $this->model; ?>"></div>
	</td>
	<td  colspan="2">
		<div class="title">Ng&#224;y kh&#7903;i h&#224;nh</div>
		<div><input size="65" type="text" onFocus="HIDE('attribute');" name="country" value="<?php echo $this->country; ?>"></div>
	</td>
</tr>
<tr>
	<td>
		<div class="title">&#272;i&#7875;m xu&#7845;t ph&#225;t</div>
		<div><input size="65" type="text" onFocus="HIDE('attribute');" name="warranty" value="<?php echo $this->warranty; ?>"></div>
	</td>
	<td  colspan="2">
		<div class="title">&#272;i&#7875;m &#273;&#7871;n</div>
		<div><input size="65" type="text" onFocus="HIDE('attribute');" name="include" value="<?php echo $this->include; ?>"></div>
	</td>
</tr>
<tr>
	<td>
		<div class="title">Gi&#225; v&#233; m&#7897;t chi&#7873;u</div>
		<div><input size="30" type="text" onFocus="HIDE('attribute');" name="price" value="<?php echo $this->price; ?>"></div>
	</td>
	<td colspan="2">
		<div class="title">Gi&#225; v&#233; hai chi&#7873;u</div>
		<div><input size="30" type="text" onFocus="HIDE('attribute');" name="unit" value="<?php echo $this->unit; ?>"></div>
	</td>
</tr>
<tr>
	<td colspan="3"><br></td>
...
<tr>
	...
	<td colspan="2">		
		...
		<div><input type="text" onFocus="HIDE('attribute');" name="alt1" class="input" value="<?php echo htmlspecialchars($this->alt1); ?>" style="width:74%" /></div>
	</td>
</tr>
</table>
</form>
