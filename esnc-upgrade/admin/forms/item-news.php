...
<tr>
	...
	<div class="title">Tag là gì?</div>
	<div><input type="text" onFocus="HIDE('attribute');" name="tag"  class="input" style="width:100%;"  value="<?php echo htmlspecialchars($this->tag); ?>" /></div>
	</td>
	<td>
...
<tr>
	...
	<td colspan="2">		
		<div><input type="text" onFocus="HIDE('attribute');" name="img1" class="input" value="<?php echo htmlspecialchars($this->img1); ?>" style="width:250px;margin-bottom:5px;" />&nbsp;<b>Giới hạn kích thước ảnh 1</b>:<input type="text"  value="<?php echo IMAGE_SIZE_NEWS1;?>" name="size_img1"  />
		<div><iframe height="30" style="padding-top:5px; " width="340" frameborder="0" scrolling="no" src="document-upload-one.php?fn=doSaveImg1"></iframe></div>
...
<tr>
	...
	<td colspan="2">		
		<div><input type="text" onFocus="HIDE('attribute');" name="img2" class="input" value="<?php echo htmlspecialchars($this->img2); ?>" style="width:250px;margin-bottom:5px;" /><b>Giới hạn kích thước ảnh 2</b>:<input type="text" value="<?php echo IMAGE_SIZE_NEWS2;?>" name="size_img2"  /></div>
		<div><iframe height="30" style="padding-top:5px; " width="340" frameborder="0" scrolling="no" src="document-upload-one.php?fn=doSaveImg2"></iframe></div>
		<div class="title">Ch&#250; th&#237;ch </div>
