...
<tr>
	<td>
		<div class="title">Gi&#225; cruise t&#7915; - &#273;&#7871;n</div>
		<div>
			<input type="text" onFocus="HIDE('attribute');" name="weight" class="input" style=" width:60px"  value="<?php echo htmlspecialchars($this->weight); ?>" />
...
<tr><td colspan="3">
	...
	<thead>
		<tr height="23" style="background-image:url(images/bg-product.gif);"><td align="center">
			...
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf0',this);">Chi ti&#7871;t</span>
