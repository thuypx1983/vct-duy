...
<tr>
	<td>
		...
		<div>
			<input type="text"  name="quantity" class="input" style="width:30px;"  value="<?php echo htmlspecialchars($this->quantity); ?>" /> Days
...
<tr>
	<td>
		<div class="title">Gi&#225; tour t&#7915; - &#273;&#7871;n</div>
		<div>
	...
	<div style="float:left;width:35%;margin-left:5px;">
			<div class="title">&#272;i&#7875;m kh&#7903;i h&#224;nh</div>
		...
		<div style="float:left;width:35%;margin-left:5px;">
			...
			<div><nobr><input type="text" onFocus="HIDE('attribute');" name="country" class="input" style="width:50%;"  value="<?php echo htmlspecialchars($this->country); ?>" /><select onchange="this.previousSibling.value=this.options[this.selectedIndex].text">		<option value="<?php echo $this->country ?>" selected><?php echo $this->country ?></option><?php echo @readfile(PATH_APPLICATION.'citycodes.htm'); ?></select></nobr></div>
		</div>
...
<tr>
	...
	<td colspan="2">
		<div style="float:left;width:100%;margin-left:5px;">
			...
			<div><nobr><input type="text" onFocus="HIDE('attribute');" name="urlrewrite" class="input" style="width:50%;"  value="<?php echo htmlspecialchars($this->urlrewrite); ?>" /></nobr></div>
		</div>
	</td>
</tr>
<tr><td colspan="3">
	...
	<thead>
		<tr height="23" style="background-image:url(images/bg-product.gif);"><td align="center">
			...
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf2',this);">Tóm tắt lịch trình</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_detail',this);">Chi ti&#7871;t Tour</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf0',this);">Tour bao g&#7891;m</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf1',this);">Tour kh&#244;ng bao g&#7891;m</span>
		</td></tr>
	</thead>
