...
<tr>
	...
	<div style="float:left;width:30%;">
		<div class="title">gi&aacute; ph&ograve;ng &#273;&#417;n</div>
		<div><input type="text" onFocus="HIDE('attribute');" name="cf[9]" class="input" style="width:150px;"  value="<?php echo htmlspecialchars($this->cf[9]); ?>" /></div>
	</div>
	<div style="float:left;width:30%;margin-left:5px;">
		<div class="title">gi&aacute; ph&ograve;ng &#273;&ocirc;i</div>
	<div><input type="text" onFocus="HIDE('attribute');" name="cf[10]" class="input" style="width:150px;"  value="<?php echo htmlspecialchars($this->cf[10]); ?>" /></div>
	</div>
	<div style="float:left;width:30%;margin-left:5px;">
		<div class="title">gi&aacute; ph&ograve;ng ba</div>
	<div><input type="text" onFocus="HIDE('attribute');" name="cf[11]" class="input" style="width:150px;"  value="<?php echo htmlspecialchars($this->cf[11]); ?>" /></div>
	</div>
	</td>
</tr>
<tr><td colspan="3">
	...
	<thead>
		<tr height="23" style="background-image:url(images/bg-product.gif);"><td align="center">
			...
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf3',this);">Direction</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf4',this);">Accomodation</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf5',this);">Restaurent & Bar</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf6',this);">Meeting & Banquet</span>
                        <strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf7',this);">Sport & Leisure</span>
                    </td></tr>
	</thead>
