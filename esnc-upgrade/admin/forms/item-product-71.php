...
<tr>
	<td>
		...
		<div>
			<input type="text" onFocus="HIDE('attribute');" name="unit" class="input" style=" width:150px"  value="<?php echo htmlspecialchars($this->unit); ?>" />
		</div>
	</td>
	<td colspan="2">
	<div style="float:left;width:60%;">
		<div class="title">urlrewrite</div>
		<div><input type="text" onFocus="HIDE('attribute');" name="urlrewrite" class="input" style="width:100%;"  value="<?php echo htmlspecialchars($this->urlrewrite); ?>" /></div>
	</div>
	</td>
</tr>
<tr><td colspan="3">
	...
	<thead>
		<tr height="23" style="background-image:url(images/bg-product.gif);"><td align="center">
			...
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf1',this);">Restaurent & Bar</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf3',this);">Excursion & activities</span>
