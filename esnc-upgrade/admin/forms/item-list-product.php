...
<table width="100%" cellpadding="0" cellspacing="0"  onClick="parent.document.getElementById('newitemmenu').style.visibility='hidden';">
	...
	<tr>
		...
		<td align="center" nowrap><a href="<?php echo URL_CWD ?>photo-list.php?PPproductid=<?php echo $row['id'] ?>&PPpagesize=20&<?php echo CATALIAS ?>id=<?php echo $this->catid ?>&PDpage=<?php echo $this->page ?>&PDpagesize=<?php echo $this->pagesize ?>" class="item">&#7842;nh</a>
			...
			<a href="<?php echo URL_CWD ?>link.php?<?php echo ALIAS ?>id=<?php echo $row['id'] ?>&<?php echo CATALIAS ?>id=<?php echo $this->catid ?>&PDpage=<?php echo $this->page ?>&PDpagesize=<?php echo $this->pagesize ?>&PDlink=product" class="item"  style="border-left:1px solid darkgray;padding-left:3px; ">Li&ecirc;n quan</a>
			...
			<a href="<?php echo URL_CWD ?>link.php?<?php echo ALIAS ?>id=<?php echo $row['id'] ?>&<?php echo CATALIAS ?>id=<?php echo $this->catid ?>&PDlink=news" class="item"  style="border-left:1px solid darkgray;padding-left:3px; ">Bài li&ecirc;n quan</a>
			<?php 
			if(PRICE_MANAGER_TYPE == 'enable')
				echo '<a href="'.URL_CWD.'package.php?'.ALIAS.'id='.$row['id'].'&'.CATALIAS.'id='.$this->catid.'&PDpage='.$this->page.'&PDpagesize='.$this->pagesize.' "class="item"  style="border-left:1px solid darkgray;padding-left:3px; ">Qu&#7843;n l&iacute; gi&aacute;</a>';
			?>
		</td>
