	...
	function process(){
		...
		switch($this->act){
			...
			case ACT_SEARCH:
				...
				exit();
			case ACT_ADD:
				include_once('../../class/catbanner.php');
				$item = new catbanner;
...
$o = new catlist;
$o->type=$o->allowpaste=TABLE_BANNER;
$o->a_ctrl = &$CATBANNER_CTRL;//array of constants definition
$o->table='catbanner';
$o->tbitem='banner';
$o->flag=&$FOLDER_FLAG;
$o->alias='CB';
...
$o->doctitle = "Qu&#7843;n tr&#7883; nh&oacute;m li&ecirc;n k&#7871;t";
$o->process();
