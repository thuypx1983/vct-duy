...
<form id="idfrmItem"  method="post" action="<?php echo URL_SELF ?>?act=<?php echo ACT_SAVE ?>&id=<?php echo $this->id; ?>&go=<?php echo urlencode(URL_GO) ?>" onSubmit="return checkForm(this);">
	...
	<tr>
		...
		<td class="text" valign="middle"><?php foreach($this->a_gender as $key=>$value) echo "<input type=\"checkbox\" class=\"input\" name=\"gender[]\" value=\"{$key}\" ".($key & $this->gender ?'checked':'')."/> {$value}&nbsp;&nbsp;";?></td>
	</tr>
	<tr>
