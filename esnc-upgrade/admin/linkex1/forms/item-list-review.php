...
<body style="margin: 0px 0px 0px 0px" class="text"><table id="item-list" width="100%" cellpadding="0" cellspacing="0"  onClick="parent.document.getElementById('newitemmenu').style.visibility='hidden';">
	...
	<tr>
		...
		<th width="<?php echo COL2_WIDTH ?>"><?php echo COL2_NAME;echo '<b>'.$this->productname.'</b>' ?></th>
		<th width="<?php echo COL3_WIDTH ?>"><a href="<?php echo URL_SELF.'?'.urlmodify($this->alias.'sortby',($this->sortby == SORTBY_ID_ASC ? SORTBY_ID_DESC : SORTBY_ID_ASC)) ?>" class="search"><?php echo COL3_NAME ?></a></th>
	...
	<tr class="review_line">
		...
		<td align="left"><div class="review_summary" style="<?php if (($row['ctrl']&1)==0) echo "color:#CCCCCC"; ?>"><?php echo $row[1]; ?></div></td>
