...
<table width="95%" cellpadding="0" cellspacing="5">
	...
	<tr>
		<td></td>
		<td border='1' alt='<?php echo $this->alt ?>' title='<?php echo $this->alt ?>' valign="top" width="200px">
	...
	<tr>
		...
		<td><textarea name="desc" rows="2" class="input" style="width:<?php echo $colsize;?>" ><?php echo $this->desc ?></textarea></td>
	</tr>
	<tr>
