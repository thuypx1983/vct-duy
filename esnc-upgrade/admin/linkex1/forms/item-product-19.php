...
<tr>
	...
	<td>
		...
		<div><input type="text"  name="price"  class="input" style="width:97%;"  value="<?php echo $this->price; ?>" /></div>
	</td>
</tr>
<tr>
	<td>
		<div class="title">Th&#7901;i l&#432;&#7907;ng</div>
		<div><input type="text"  name="manufacturer" class="input" style="width:150px;"  value="<?php echo $this->manufacturer; ?>" /></div>
	</td>
	<td colspan="2">
	<div style="float:left;width:49%;">
		<div class="title">&#272;i&#7875;m xu&#7845;t ph&#225;t</div>
		<div><input type="text" name="include" class="input" style="width:150px"  value="<?php echo $this->include; ?>" /><select onchange="this.previousSibling.value=this.options[this.selectedIndex].text">
		...
		<div><input type="text" name="unit" class="input" style="width:150px;"  value="<?php echo $this->unit; ?>" /><select onchange="this.previousSibling.value=this.options[this.selectedIndex].text">
...
<tr>
	...
	<td colspan="2"><div class="title">L&#7897; tr&igrave;nh tour</div>
	<div><input type="text" onFocus="HIDE('attribute');" name="cf[0]" style="width:80%;"  value="<?php echo htmlspecialchars($this->cf[0]); ?>" /></div></td>	
</tr>
...
<tr><td colspan="3">
	...
	<thead>
		<tr height="23" style="background-image:url(images/bg-product.gif);"><td align="center">
			...
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf2',this);">Brief of Itinerary</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_detail',this);">Details of Itinerary</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_warranty',this);">Package price</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf1',this);">Tour Highlight</span>						
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf3',this);">More Inquiry</span>
			<!--<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf4',this);">S&#417; &#273;&#7891;</span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf9',this);"><?php //echo T_DESCRIPTION; ?></span>
			<strong> | </strong><span name="tabhead" class="tabhead" onClick="showTab('_cf10',this);"><?php //echo T_CONTENT_RELATE; ?></span>-->
		</td></tr>
	</thead>
