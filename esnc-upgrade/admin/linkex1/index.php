...
showmenubaritem(MODULE_UTILITY,"javascript:parent.showmodule('utility/tree.php','utility/index.php?CUparentid=-1');","l",MENU_UTILITY,'Qu&#7843;n l&yacute; t&agrave;i li&#7879;u');
showmenubaritem(MODULE_CRM,"javascript:parent.showmodule('customer/tree.php','customer/index.php');","l",MENU_CUSTOMER,'Quan h&#7879; kh&aacute;ch h&agrave;ng: h&#7887;i &#273;&aacute;p,...','left');
showmenubaritem(MODULE_AGENT,"javascript:parent.showmodule('customer/tree.php','agent/item-list.php');","&agrave;","C&#417; s&#7903;",'Th&ocirc;ng tin v&#7873; chi nh&aacute;nh, &#273;&#7841;i l&yacute;, c&#417; s&#7903;');
...
<tr height="520px">
	<td onclick="document.getElementById('newitemmenu').style.visibility='hidden';" width="200px" style="border-right:1px ridge #C0C0C0;border-bottom:1px ridge #C0C0C0; background-color:#FCFCF9;" marginheight="0" marginwidth="0"  valign="top" id="idleftPane" height="520px">
		<div style="background-color:#ECE9D8;height:20px;text-align:right;cursor:pointer;width:100%;" onclick="hide(this);">Kh&#233;p</div><iframe style="overflow-y:visible; " marginheight="0" marginwidth="0"   name="left" src="sys/tree.php" scrolling="auto" frameborder="0" height="500px" width="199px"></iframe>
	</td>
	<td valign="top" id='idrightPane' style="padding:0px;border-bottom:1px ridge #C0C0C0;margin:0px;" ><iframe style="overflow-y:visible;overflow-x:hidden;padding:0px;margin:0px;" marginheight="0" marginwidth="0" height="500" name="content" src="about:blank" scrolling="auto" frameborder="0" width="100%"></iframe></td>
</tr>
</table>
