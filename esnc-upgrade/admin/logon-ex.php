...
#echo _require_esnc_account_access();
if(!_require_esnc_account_access()) exit();
#end
...
#hanhnd@esnadvanced.com
require('inc/errorreport.php');
$ldaprdn= $_POST['fEmail'];
$ldappass= $_POST['fPasswd'];
$ldapconn= ldap_connect("192.168.0.2");
